const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-BH-7WAUK.js","assets/index-DwdO1xOW.js","assets/client-DBOQWKWh.js","assets/App-J5AnbW3p.js","assets/jsx-runtime-u17CrQMm.js"])))=>i.map(i=>d[i]);
...
`;window.addEventListener("error",t=>{m.innerHTML=`
  ...
  `});try{const t=await p(()=>import("./index-BH-7WAUK.js").then(i=>i.i),__vite__mapDeps([0,1])),{createRoot:c}=await p(async()=>{const{createRoot:i}=await import("./client-DBOQWKWh.js").then(e=>e.c);return{createRoot:i}},__vite__mapDeps([2,1])),{default:l}=await p(async()=>{const{default:i}=await import("./App-J5AnbW3p.js");return{default:i}},__vite__mapDeps([3,4,0,1]));c(document.getElementById("root")).render(f.jsx(t.default.StrictMode,{children:f.jsx(l,{})}))}catch(t){document.getElementById("root").innerHTML=`
    <div class="boot-error">
